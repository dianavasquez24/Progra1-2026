...
using namespace std;
const double PI = 3.14159; // colocamos pi como constante 

float CalcularVolumen(float radio, float altura = 10);  // definimos altura solo una vez dentro el prototipo
